const factions = [
    ...
    {name: "The Guild", text: "An organization that gathers adventurers from all over the world. They help people in exchange for a reward. They follow the law and have a moral code.", alignment: "lawful neutral", slug: "the-guild"},
    {name: "Mercenaries", text: "An organization formed by a man banned from the Guild. They have no ethics and will do anything for the right reward.", alignment: "neutral neutral", slug: "mercenaries"},
    {name: "Sky Pirates", text: "A group of pirates who have found weapons allowing them to master wind.", alignment: "chaotic neutral", slug: "sky-pirates"},
    ...
    {name: "Skeletons", text: "Created by a powerful witch who wanted to overcome death. Only magic can defeat them since they are immune to physical damage.", alignment: "neutral evil", slug: "skeletons"},
    ...
    {name: "Heroes of Ninjago", text: "Created by Dr. Doom, this association gathers people with special abilities to protect Ninjago City and its citizens.", alignment: "lawful good", slug: "heroes-of-ninjago"},
    ...
    {name: "Lion Tribe", text: "An animal tribe that gained consciousness after drinking pure Chi. The Lions guard the sacred pond and distribute Chi fairly among tribes. They are noble, proud, and loyal.", alignment: "lawful neutral", slug: "lion-tribe"},
    {name: "Crocodile Tribe", text: "An animal tribe that gained consciousness after drinking pure Chi. Violent warriors, the Crocodiles are also the best-known swimmers and the second-largest Chima tribe after the Lions. Their relationship with the Lions is always tense due to their differing values.", alignment: "chaotic neutral", slug: "crocodile-tribe"},
    {name: "Eagle Tribe", text: "An animal tribe that gained consciousness after drinking pure Chi. The Eagle tribe is mainly composed of scholars and pacifists. They love knowledge and have one of the best libraries.", alignment: "lawful neutral", slug: "eagle-tribe"},
    {name: "Wolf Tribe", text: "An animal tribe that gained consciousness after drinking pure Chi. The wolves are the only nomadic tribe, and they share a strong bond with each other.", alignment: "chaotic neutral", slug: "wolf-tribe"},
    {name: "Gorilla Tribe", text: "An animal tribe that gained consciousness after drinking pure Chi. They like to relax. Gorillas are either eating, exercising, or sleeping. They also adopted the last two members of the Rhino Tribe.", alignment: "chaotic neutral", slug: "gorilla-tribe"},
    {name: "Bear Tribe", text: "An animal tribe that gained consciousness after drinking pure Chi. They spend most of their time sleeping. They only wake up for important things such as honey, salmon, or an invasion from the Ice Tribes.", alignment: "neutral good", slug: "bear-tribe"},
    {name: "Raven Tribe", text: "An animal tribe that gained consciousness after drinking pure Chi. The greediest tribe in Chima, they will do anything for gold.", alignment: "neutral evil", slug: "raven-tribe"},
    {name: "Snake Tribe", text: "An animal tribe that gained consciousness after drinking pure Chi. The Snake tribe was banned long ago from Chima. Over generations, they forgot their origins and Chi. Each subspecies possesses powerful venom with various effects. After their banishment, they established themselves on the continent of Ninjago.", alignment: "chaotic neutral", slug: "snake-tribe"},
    {name: "Sea Tribe", text: "An animal tribe that gained consciousness after drinking pure Chi. They live deep in the sea and usually stay hidden, away from surface conflicts.", alignment: "chaotic neutral", slug: "sea-tribe"},
    {name: "Phoenix Tribe", text: "An animal tribe that gained consciousness after drinking pure Chi. The oldest Chima tribe and creator of Fire Chi. They live on top of the sacred mountain and only reveal themselves when the Ice Tribes try to conquer Chima.", alignment: "lawful good", slug: "phoenix-tribe"},
